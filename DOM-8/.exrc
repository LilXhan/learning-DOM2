...
set tabline=%1@BufferlineMainClickHandler@%#BufferCurrentSign#▎\ \ \ \ %1@BufferlineMainClickHandler@%#DevIconJsCurrent#\ %1@BufferlineMainClickHandler@%#BufferCurrent#main.js\ \ \ \ \ %1@BufferlineCloseClickHandler@%#BufferCurrent#\ %0@BufferlineMainClickHandler@%#BufferTabpageFill#▎%#BufferTabpageFill#
set tabstop=2
set termguicolors
set window=38
" vim: set ft=vim :
